              ...
              <div className="flex justify-end items-center  w-15 pr-5 md:pr-0">
                {User?.active === "true" ? (
                  ...
                  >
                    ...
                    />
                    {activeDrop && (
                      <div className="absolute  top-8 bg-[#daaeee]  border-2 rounded-sm border-[#9731c7] py-2 px-5 right-1 w-40 text-start">
                  ...
                  >
                    ...
                    />
                    {activeDrop && (
                      <div className="absolute top-8 bg-[#f3ac9e] border-2 rounded-sm border-[#9731c7] py-2 px-5 right-1 w-40 text-start">
